...
<html lang="en">
    ...
    <body>
        <main class="d-flex flex-column mx-3">
            ...
            <p class="mb-4 h4">4) Run --> <b> cd typeScriptToJava/java/ <-- 
            <p class="mb-4 h4">5) Run --> <b>javac User.java</b> <-- in your terminal, it should not return an error and create 3 files in the <b>typeScriptToJava/java</b> folder : "User.class", "Photo.class" and "Address.class"</p>
        </main>
